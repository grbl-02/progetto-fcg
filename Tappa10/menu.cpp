...
Menu::Menu(sf::Font& font) : start_game(font, "START GAME", 8.f), hard_mode(font, "HARD MODE", 8.f), description(font, "You only have 1 HP. You get hit, you die.", 8.f), quit(font, "QUIT", 8.f)
{
    option = 0;
}
